...
EXACT_CHECKS = {
    ...
    "Language": {"Word_toward", "AvoidEtc", "AvoidShould", "ProximityRedundant",
                 ...
                 "NoFeelTechnical", "NoAboveBelow", "PreferMetric"},
    "Punctuation": {"NoAmpersand", "PercentSymbol", "NoApostrophePlurals", "NumberCommas",
                    ...
                    "TimeFormat", "DateFormat_Text", "DateFormat_Table", "YearIntervalFormat",
                    "NoSpacesAroundSlash", "AvoidForwardSlash", "HyphenInWords", "HyphenSuffixes",
                    "HyphenAlwaysPrefix", "Hyphen_wide", "PunctuationBeforeEgIe", "OxfordComma",
                    "NumbersBelowTen", "CaptionNoPeriod"},
